 ...
 * @version 3.0
 */
public class BloodPressure extends BodyInformation {

	private static final BloodPressureStatus[] status = {
		new BloodPressureStatus(120, 80, "NORMAL"),
		new BloodPressureStatus(139, 89, "PRÉ-HIPERTENSÃO"),
		new BloodPressureStatus(159, 99, "HIPERTENSÃO ESTÁGIO 1"),
		new BloodPressureStatus(179, 109, "HIPERTENSÃO ESTÁGIO 2"),
		new BloodPressureStatus(200, 120, "HIPERTENSÃO ESTÁGIO 3")
	};
	 ...
	 */
	public BloodPressure(int userId, int systolicValue,
	...
	public BloodPressure(int id, int userId,
	 ...
	 * @param userId   Identificador do usuário.
	 */
	public BloodPressure(int id, int userId, int systolicValue,
	...
	public String getStatus() {
		for(BloodPressureStatus currentStatus : status) {
