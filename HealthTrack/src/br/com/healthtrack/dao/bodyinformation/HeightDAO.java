...
import br.com.healthtrack.bean.bodyinformation.Height;
 ...
 * @version 2.0
 */
public class HeightDAO implements DAOInterface<Height>{
	 ...
	 */
	@Override
	public void create(Height height) throws DBException {
	 ...
	 */
	@Override
	public void destroy(int... heightId) throws DBException {
		sqlQuery = new StringBuilder();
