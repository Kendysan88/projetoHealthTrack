							...
							<div class="row no-gutters">
								...
								<div class="col-md-8">
									<div class="card-body">
										...
										<p class="card-text">
											<small class="text-muted">Última atualização foi a 3
												minutos atrás</small>
										</p>
										<h5 class="card-title cor-especial cartao-titulo-perfil">Informações
											do Usuário</h5>
										<div class="row">
											<div class="col-md-6">
												<label>Sexo</label>
										...
										<h5 class="card-title cor-especial cartao-titulo-perfil">Nível
											de Atividade</h5>
