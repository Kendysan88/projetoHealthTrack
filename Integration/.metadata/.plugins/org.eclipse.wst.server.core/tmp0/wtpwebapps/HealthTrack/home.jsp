...
<body>
				...
				<div class="container pb-5">
						...
						<article class="card mb-2" style="width: 22rem;">
							<div class="card-body">
								<h5 class="cartao-titulo card-title">
									<i class="icone-cartao fas fa-running"></i> Exercícios
								</h5>
							...
							<div class="card-body">
								<h5 class="cartao-titulo card-title text-left">
									<img src="resources/img/blood-pressure-black.svg"
										class="icone-pressao-arterial-preto"> Pressão Arterial
								</h5>
					...
					<div class="row mt-4">
						...
						<div class="col-xl-6">
							<article class="card mb-4">
								<div class="cartao-titulo card-header">
									<i class="icone-cartao fas fa-weight"></i>Evolução do Peso
								</div>
								<div class="card-body">
	...
	<!-- Modais Exercícios, Alimentos e Peso -->
