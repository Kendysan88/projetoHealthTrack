 ...
 * Generated at: 2020-11-02 19:59:14 UTC
...
public final class food_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/food-modal.jsp", Long.valueOf(1604328239284L));
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t<h1 class=\"mt-4\">Gerenciar Alimentos</h1>\r\n");
      out.write("\t\t\t\t<ol class=\"breadcrumb mb-4\">\r\n");
      out.write("\t\t\t\t\t<li class=\"breadcrumb-item\"><a href=\"home.jsp\">Dashboard</a></li>\r\n");
      out.write("\t\t\t\t\t<li class=\"breadcrumb-item active\">Gerenciar Alimentos</li>\r\n");
      out.write("\t\t\t\t</ol>\r\n");
      out.write("\t\t\t\t<div class=\"card mb-4\">\r\n");
      out.write("\t\t\t\t\t<div class=\"card-header cartao-titulo\">\r\n");
      out.write("\t\t\t\t\t\t<i class=\"icone-cartao fas fa-weight\"></i> Lista de Alimentos\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th>Tipo de Refeição</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th>Alimentos Ingeridos</th>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th>Tipo de Refeição</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th>Alimento Ingerido</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th>Quantidade</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th colspan=\"2\">Ações</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tfoot>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>Lorem ipsum dolor sit amet consectetur adipisicing\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\telit.</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>Magni provident placeat a eum corrupti mollitia fuga.</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>XXX, X kcal ou g ou ml</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td class=\"border-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn cor-botao\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tdata-toggle=\"modal\" data-target=\"#modalAlimento\">\r\n");
      ...
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label for=\"\">Alimento Ingerido</label> <input type=\"text\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group col-md-6\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<label for=\"\">Unidade</label> <select name=\"\" id=\"\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"form-control\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option selected>Escolha...</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option>ml</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option>g</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option>calorias</option>\r\n");
