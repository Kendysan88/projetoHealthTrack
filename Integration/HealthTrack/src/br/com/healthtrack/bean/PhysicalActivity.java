...
public class PhysicalActivity implements Comparable<PhysicalActivity> {
	 ...
	 */
	public PhysicalActivity(int physicalActivityId, String activityName, LocalDateTime date, LocalDateTime startTime, LocalDateTime endTime, double calories, String activityType) {
	 ...
	 */
	public PhysicalActivity(int physicalActivityId, String activityName, LocalDateTime date, LocalDateTime startTime, LocalDateTime endTime, double calories, String activityType, double distance) {
		this.physicalActivityId = physicalActivityId;
		this.activityName = activityName;
		this.date = date;
		this.startTime = startTime;
	...
	public String getDatePretty() {
		return Utils.formatDateTime(getDate());
	}
