...
public class PhysicalActivityBySeries extends PhysicalActivity {
	...
	public PhysicalActivityBySeries(int physicalActivityId, String activityName, LocalDateTime date, LocalDateTime startTime, LocalDateTime endTime, double calories,String activityType) {
		super(physicalActivityId, activityName, date, startTime, endTime, calories, activityType);

	}	
	public PhysicalActivityBySeries(int physicalActivityId, String activityName, LocalDateTime date, LocalDateTime startTime, LocalDateTime endTime, double calories,String activityType, double distance) {
		super(physicalActivityId, activityName, date, startTime, endTime, calories, activityType, distance);
	 ...
	 */
	public PhysicalActivityBySeries(int physicalActivityId, String activityName, LocalDateTime date, LocalDateTime startTime, LocalDateTime endTime, double calories,String activityType,int series, int repetitions, double liftedWeight) {
		super(physicalActivityId, activityName, date, startTime, endTime, calories, activityType);
		this.series = series;
	 ...
	 * @param liftedWeight		Quantidade de peso necessário para realizar a atividade. 
	 */
	public PhysicalActivityBySeries(int physicalActivityId, String activityName, LocalDateTime date, LocalDateTime startTime, LocalDateTime endTime, double calories,String activityType,double distance, int series, int repetitions, double liftedWeight) {
		super(physicalActivityId, activityName, date, startTime, endTime, calories, activityType, distance);
		this.series = series;
		this.repetitions = repetitions;
		this.liftedWeight = liftedWeight;
